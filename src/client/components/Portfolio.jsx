  ...
  return ( 
    ...
    <Paper elevation={1} sx={{ backgroundColor: '#d9d9d9', color: '#181818', padding: '20px', margin: '10px' }}>
      <Typography variant="h5" color="#003300" component="div">
        #1 Puppy Bowl - <a href="https://664255b4e94e3705d7a90302--bespoke-pixie-99297e.netlify.app/" target="_blank" style={{ textDecoration: 'underline overline' }}>🐶 click me</a>
      </Typography>
      ...
      <Typography variant="h7" color='#003300' fontWeight='900'>
        TECHNOLOGIES IMPLIMENTED: React-Redux, React Router, Redux Toolkit, HTML5, CSS, Javascript, Javascript APIs
      </Typography>
    </Paper>
    <Paper elevation={1} sx={{ backgroundColor: '#d9d9d9', color: '#181818', padding: '20px', margin: '10px' }}>
      <Typography variant="h5" color="#003300" component="div">
        #2 Book Buddy - <a href="https://66427587496fcb2483ba46cf--celebrated-crostata-770299.netlify.app/" target="_blank" style={{ textDecoration: 'underline overline' }}>📗 click me</a>
      </Typography>
      <Typography variant="body2" color="#181818" component="p">
      ...
      <Typography variant="h7" color='#003300' fontWeight='900'>
        TECHNOLOGIES IMPLIMENTED: React, React Router, React Hooks, Redux Toolkit, RTK Query, Authentication (guest/login), HTML5, CSS, Javascript, APIs
      </Typography>
    </Paper>
    <Paper elevation={1} sx={{ backgroundColor: '#d9d9d9', color: '#181818', padding: '20px', margin: '10px' }}>
      <Typography variant="h5" color="#003300" component="div">
        #3 Classroom Manager - <a href="tbd" target="_blank" style={{ textDecoration: 'underline overline' }}>🧑‍🏫 not deployed yet</a>
      </Typography>
      <Typography variant="body2" color="#181818" component="p">
      ...
      <Typography variant="h7" color='#003300' fontWeight='900'>
        TECHNOLOGIES IMPLIMENTED: React-Redux, React-Router, Redux Toolkit, Express JS, PostgreSQL, Prisma ORM, bcrypt encryption, GitHub OAuth
      </Typography>
    </Paper>
    <Paper elevation={1} sx={{ backgroundColor: '#d9d9d9', color: '#181818', padding: '20px', margin: '10px' }}>
      <Typography variant="h5" color="#003300" component="div">
        #4 Full Stack eCommerce Applcation - <a href="tbd" target="_blank" style={{ textDecoration: 'underline overline' }}>💸 not deployed yet</a>
      </Typography>
      <Typography variant="body2" color="#181818" component="p">
