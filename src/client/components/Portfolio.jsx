...
const responsive = {
  superLargeDesktop: {
    // the naming can be any, depends on pref
  ...
  return (
    <>
      <div className="projectCarousel">
        <Typography variant="h7" color='#003300' fontWeight='900' backgroundColor='#CCFFCC' sx={{ display: 'flex', justifyContent: 'center' }}>
        ...
        <Paper elevation={1} sx={{ backgroundColor: '#d9d9d9', color: '#181818', padding: '20px', margin: '10px' }}>
          <Carousel responsive={responsive}>
            <div>
              <Paper elevation={5} sx={{ backgroundColor: '#d9d9d9', color: '#181818', padding: '20px', margin: '10px' }}>
